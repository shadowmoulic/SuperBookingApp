  ...
  return (
    <nav className="pt-6 pb-6 px-8 border-b border-gray-100">
      <div className="max-w-7xl mx-auto flex items-center justify-between gap-8">
        ...
        <div className="flex-1 max-w-xl relative">
          <div class="rounded-full bg-gradient-to-r from-[var(--md-sys-color-primary-bright-src)] to-[var(--md-sys-color-primary)] p-[3px]">
            <div class="rounded-[calc(theme(borderRadius.lg)-2px)] bg-white rounded-full">
              <input
                className="w-full pl-6 pr-12 py-3 rounded-full focus:outline-none focus:border-none focus:ring-1 focus:ring-brand-dark text-sm placeholder-gray-500"
        ...
        <div className="flex items-center space-x-6 text-s font-semibold tracking-wider shrink-0">
          <div className="flex items-center space-x-4 gap-4">
            <Link to="/my-bookings">
              <div className="flex items-center hover:opacity-80 hover:text-[var(--md-sys-color-primary)]">
                <svg
            ...
            {user ? (
              <>
                <button
                  onClick={logout}
                  className="bg-[var(--md-sys-color-primary)] hover:bg-[var(--md-sys-color-primary-container)] text-[var(--md-sys-color-on-primary)] hover:text-[var(--md-sys-color-on-primary-container)] px-4 py-2 rounded-full cursor-pointer"
                >
