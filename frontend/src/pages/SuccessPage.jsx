  ...
  return (
    <div className="min-h-screen bg-gray-50/50 flex flex-col font-['Inter'] py-8 px-6">
      <div className="animate-scale-in max-w-xl mx-auto text-center flex flex-col items-center justify-center w-full">
        ...
        {/* Success Banner */}
        <div className="w-20 h-20 bg-green-500 rounded-full flex items-center justify-center text-white shadow-[0_0_30px_rgba(34,197,94,0.4)] animate-bounce mb-6">
          <span className="material-symbols-outlined text-4xl">check</span>
        </div>
        ...
        <div className="bg-white rounded-xl border border-gray-150 p-6 w-full max-w-sm relative overflow-hidden shadow-md my-6">
          ...
          <div className="grid grid-cols-2 gap-y-3 gap-x-4 text-xs text-gray-500 mb-6 border-t border-gray-50 pt-4 text-left">
            <div>
            ...
            <div>
              ...
              <span className="font-semibold text-gray-700">{booking?.total_tickets} Adult</span>
            </div>
            <div>
